...
function bbloomer_privacy_message_below_checkout_button(): void {
	if (is_user_logged_in()) return;

	echo '<p><strong>Zufriedenheitsgarantie:</strong> Neukunden testen Arthrofill ohne Risiko. Bei Unzufriedenheit nehmen wir eine 
angebrochene Packung innerhalb von 30 Tagen zurück und erstatten den Kaufpreis (Ausgenommen Arthrofill Duo).</p>';
}
